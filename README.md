...
The project compares **Deep Autoencoders (AE)** and **f-AnoGAN** architectures against a domain-constrained **Masked Fast Gradient Sign Method (FGSM)** attack using the **UNSW-NB15** and **CIC-IDS2017** datasets.
...
# Train the GANs and f-AnoGAN Encoders
python gan_train.py
```
